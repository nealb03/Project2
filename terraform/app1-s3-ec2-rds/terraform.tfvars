...
# VPC and subnet info (example CIDR blocks, replace with your actual subnet IDs if needed)
...
# RDS Database configurations matching your resource block
...
# EC2 configurations (example values, adjust as needed)
enable_ec2          = true
instance_type       = "t3.medium"
subnet_id_for_ec2   = "subnet-xxxxxxxx"  # Replace with your actual subnet id for EC2
